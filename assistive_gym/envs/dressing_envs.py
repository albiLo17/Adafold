...
class DressingPandaIKMeshEnv(DressingEnv):
    def __init__(self):
        super(DressingPandaIKMeshEnv, self).__init__(robot=Panda(robot_arm), human=None, use_ik=True)
register_env('assistive_gym:DressingPandaIKMeshEnv-v1', lambda config: DressingPandaIKMeshEnv())
