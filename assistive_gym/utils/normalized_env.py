...
from assistive_gym.utils.overrides import overrides
...
class NormalizedEnv(object):
    ...
    def step(self, action, **kwargs):
        ...
        # surrogate_next_obs = np.zeros_like(next_obs).reshape(-1, 3)
        # surrogate_next_obs[24] = next_obs.reshape(-1, 3)[24]
        # next_obs = surrogate_next_obs.reshape(-1)
